...
def subject_detail_music_select(conn, where_sql):
    select_sql = """ select
		...
		sale_date, price, time_length, discs_num, intro, 
...
def subject_detail_music_insert(conn, dto: subject_detail_music_dto.SubjectDetailMusicDTO):
    insert_sql = """ insert into subject_detail_music(
		...
		price, time_length, discs_num, intro, topic_list_id, 
    ...
    params = (
        ...
        dto.price, dto.time_length, dto.discs_num, dto.intro, dto.topic_list_id,
...
def subject_detail_music_update(conn, dto: subject_detail_music_dto.SubjectDetailMusicDTO):
    update_sql = """
		...
		time_length= %s, discs_num= %s, intro= %s, topic_list_id= %s, comment_box_id= %s, 
    ...
    params = (
        ...
        dto.time_length, dto.discs_num, dto.intro, dto.topic_list_id, dto.comment_box_id,
