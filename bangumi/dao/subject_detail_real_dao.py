...
def subject_detail_real_insert(conn, dto: subject_detail_real_dto.SubjectDetailRealDTO):
    insert_sql = """ insert into subject_detail_real(
		...
		south_asia_name, website, imdb_id, tv_com_id, intro, 
    ...
    params = (
        ...
        dto.south_asia_name, dto.website, dto.imdb_id, dto.tv_com_id, dto.intro,
...
def subject_detail_real_update(conn, dto: subject_detail_real_dto.SubjectDetailRealDTO):
    update_sql = """
		...
		website= %s, imdb_id= %s, tv_com_id= %s, intro= %s, topic_list_id= %s, 
    ...
    params = (
        ...
        dto.website, dto.imdb_id, dto.tv_com_id, dto.intro, dto.topic_list_id,
