...
def subject_detail_game_select(conn, where_sql):
    select_sql = """ select
		...
		website, intro, topic_list_id, comment_box_id, system_score_id, 
...
def subject_detail_game_update(conn, dto: subject_detail_game_dto.SubjectDetailGameDTO):
    update_sql = """
		...
		player_num= %s, sale_date= %s, price= %s, website= %s, intro= %s, 
    ...
    params = (
        ...
        dto.player_num, dto.sale_date, dto.price, dto.website, dto.intro,
