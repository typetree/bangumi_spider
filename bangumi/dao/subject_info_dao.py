...
def subject_info_select(conn, where_sql):
    select_sql = """ select
		...
		type, picture, bangumi_subject_id, topic_list_id, comment_box_id, 
...
def subject_info_insert(conn, dto: subject_info_dto.SubjectInfoDTO):
    insert_sql = """ insert into subject_info(
		...
		picture, bangumi_subject_id, topic_list_id, comment_box_id, system_score_id, 
		system_tag_id, remark, status, creator, create_time, 
		updater, update_time)
	values(
		%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, 
		%s, %s, %s, %s, %s, %s, %s) """
    ...
    params = (
        ...
        dto.picture, dto.bangumi_subject_id, dto.topic_list_id, dto.comment_box_id, dto.system_score_id,
...
def subject_info_update(conn, dto: subject_info_dto.SubjectInfoDTO):
    update_sql = """
		...
		bangumi_subject_id= %s, topic_list_id= %s, comment_box_id= %s, system_score_id= %s, system_tag_id= %s, 
    ...
    params = (
        ...
        dto.bangumi_subject_id, dto.topic_list_id, dto.comment_box_id, dto.system_score_id, dto.system_tag_id,
